...
<div id="j-main-container" class="main-card p-lg-3 p-md-3">
    <form action="<?php echo JRoute::_('index.php?option=com_mailjet&layout=edit') ?>" method="post" id="adminForm"
          name="adminForm">
        <div id="editcell">
            ...
            <fieldset class="options-form">
                ...
                <div class="control-group">
                    <div class="control-label"><label
                                for="enable"><?php echo Text::_('COM_MAILJET_GENERAL_SETTINGS_ENABLED'); ?></label>
                    </div>
                    <div class="controls">
                        <input type="checkbox" name="enable" id="enable" <?php if($this->params ['enable']) {
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="checkbox" name="test" id="test" <?php if($this->params ['test']) {
                            echo 'checked="checked"';
                        } ?> />
                    </div>
                </div>
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" name="test_address" id="test_address" class="form-control"
                               value="<?php echo $this->params ['test_address']; ?>"/>
                    </div>
                </div>
            </fieldset>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" name="username" id="username" class="form-control"
                               value="<?php echo $this->params['username']; ?>"/>
                    </div>
                </div>
                <div class="control-group">
                    <div class="control-label">
                    ...
                    <div class="controls">
                        <input type="text" name="password" id="password" class="form-control"
                               value="<?php echo $this->params['password']; ?>"/>
                    </div>
                </div>
            </fieldset>
        </div>
